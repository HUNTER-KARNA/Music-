...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("Hunters")
                await self.one.join_chat("GodHunters")
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("Hunters")
                await self.two.join_chat("GodHunters")
                await self.two.join_chat("HunterXSupport")
            except:
                pass
            assistants.append(2)
            try:
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("Hunters")
                await self.three.join_chat("GodHunters")
                await self.three.join_chat("HunterXSupport")
            except:
                pass
            assistants.append(3)
            try:
        ...
        if config.STRING4:
            ...
            try:
                ...
                await self.four.join_chat("")
                await self.four.join_chat("HunterXSupport")
            except:
                pass
            assistants.append(4)
            try:
        ...
        if config.STRING5:
            ...
            try:
                ...
                await self.five.join_chat("")
                await self.five.join_chat("HunterXSupport")
            except:
                pass
            assistants.append(5)
            try:
